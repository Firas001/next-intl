...
const HeroHome = () => {
  return (
    <>
      <Container>
        <Grid gutter={50}>
          <GridCol span={{ base: 12, lg: 6 }} style={{ alignItems: "center" }}>
            <Flex direction="column" align="flex-start" gap={20}>
              <Title className={classes.grColor}>
                <span className={classes.blackfw500}>نص</span> افتراضي
                <span className={classes.blackfw500}> يعرض</span>{" "}
                <span className={classes.black}>عنوان خاص </span>
                غير حقيقي
              </Title>
              ...
              <Button
                ...
                px={40}
                h={50}
                style={{ boxShadow: "0px 0px 30px  rgb(204, 204, 204)" }}
              >
                اطلق خدماتك الإلكترونية الآن
              </Button>
            </Flex>
          </GridCol>

          <GridCol span={{ base: 12, lg: 6 }} pl={50}>
            <Image src={HeroWrapper.src} alt="hero wrapper" />
          </GridCol>
        </Grid>
      </Container>
    </>
